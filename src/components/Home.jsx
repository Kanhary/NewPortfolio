  ...
  return (
    <section className="min-h-[500px] flex flex-col justify-center items-center text-center px-4 md:px-16 font-khmer bg-transparent">
      ...
      <div className="mt-8 space-x-4">
        <button onClick={onNavigate.project} className="px-6 py-3 border text-white bg-black text-sm hover:bg-transparent hover:text-black hover:border-black transition duration-300 rounded-tl-md rounded-br-md">
          View My Works
        </button>
